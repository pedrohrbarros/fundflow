...
ALTER TABLE "sources_of_income" ADD COLUMN IF NOT EXISTS "date" DATE;
...
ALTER TABLE "sources_of_income" ADD COLUMN IF NOT EXISTS "is_recurring" BOOLEAN NOT NULL DEFAULT false;
