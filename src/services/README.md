...
| ---------------------- | ------------------------ | ------------------------------------- |
| `categories.ts`        | `CategoriesService`      | CRUD for `SourceOfIncomeCategory`     |
| `sources_of_income.ts` | `SourcesOfIncomeService` | CRUD for `SourceOfIncome`             |
| `payment_methods.ts`   | `PaymentMethodsService`  | User-scoped CRUD for `PaymentMethod`  |
